...
```bash
$ planqd tx slashing unjail --from node1 --chain-id cro-test
...
[https://rest.planq.network/cosmos/slashing/v1beta1/params](https://rest.planq.network/cosmos/bank/v1beta1/params)
